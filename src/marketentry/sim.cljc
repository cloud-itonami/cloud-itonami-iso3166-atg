...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (ATG, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up vendor-class-insufficient) ==")
    ...
    (println "== filing/submit eng-4 (vendor-class-insufficient -> HARD hold) ==")
